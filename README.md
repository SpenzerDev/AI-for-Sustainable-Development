...
*By predicting and influencing both factors in the equation—optimizing the supply side to lower $\text{CI}$ and optimizing the demand side to shift consumption away from high-$\text{CI}$ periods—the system delivers a measurable reduction in $\text{CO}_2$ emissions. This directly contributes to Target 13.2 of the SDGs: integrating climate change measures into national policies, strategies, and planning.
